...
export const bookingsAPI = {
  ...
  getAddressSuggestions: (query: string, limit?: number) =>
    api.post('/bookings/geocode/suggestions', { query, limit }),
  updateTracking: (id: string, data: { lat: number; lng: number; estimatedArrival?: string }) =>
    api.post(`/bookings/${id}/tracking`, data),
};
